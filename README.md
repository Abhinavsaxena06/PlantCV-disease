...
```powershell
git clone  https://github.com/Abhinavsaxena06/PlantCV-disease.git
cd PlantDiseaseCV
```
...
GitHub: [Abhinavsaxena06](https://github.com/Abhinavsaxena06)

Repository: [PlantDiseaseCV]( https://github.com/Abhinavsaxena06/PlantCV-disease.git)
